...
namespace DBFirst
{
    ...
    public partial class PlutoContext : DbContext
    {
        ...
        [DbFunction("PlutoContext", "funcGetAuthorCourses")]
        public virtual IQueryable<funcGetAuthorCourses_Result> funcGetAuthorCourses(Nullable<int> authorID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<funcGetAuthorCourses_Result>("[PlutoContext].[funcGetAuthorCourses](@AuthorID)", authorIDParameter);
        }
